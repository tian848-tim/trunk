...
class VendorDocument(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/VendorDocument_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '供应商档案——删除'
        # 脚本标识－ID
        self.script_id = 'VendorDocument_delete'
    ...
    def test_VendorDocument(self):
        ...
        # 定位到删除
        self.driver.find_element_by_xpath("//*[@id='VendorDocumentView']//span[contains(@class,'fa-trash')]").click()
