...
class Refund(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_balancerefund_FlowBalanceRefund_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－标题
        self.script_name = '差额退款——复制'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_balancerefund_FlowBalanceRefund_copy'
    ...
    def test_flow_balance_refund(self):
        ...
        # 定位到额退款复制按钮
        self.driver.find_element_by_xpath("//*[@id='FlowBalanceRefundView']//span[contains(@class,'fa-copy')]").click()
