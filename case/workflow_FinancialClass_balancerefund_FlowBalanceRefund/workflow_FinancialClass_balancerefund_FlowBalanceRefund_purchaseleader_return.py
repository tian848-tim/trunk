...
class Refund(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_balancerefund_FlowBalanceRefund_purchaseleader_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－标题
        self.script_name = '差额退款——采购组长退回'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_balancerefund_FlowBalanceRefund_purchaseleader_return'
    ...
    def test_flow_balance_refund(self):
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowBalanceRefundForm']//span[contains(@class, 'fa-reply')]").click()
