...
class Refund(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_balancerefund_FlowBalanceRefund_AUaccountant_invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－标题
        self.script_name = '差额退款——AU会计作废'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_balancerefund_FlowBalanceRefund_AUaccountant_invalid'
    ...
    def test_flow_balance_refund(self):
        ...
        # 点击作废
        self.driver.find_element_by_xpath("//*[@id='FlowBalanceRefundForm']//span[contains(@class, 'flowcancel')]").click()
