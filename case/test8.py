...
class purchaseContract(unittest.TestCase):
    ...
    def loadvendername(self):
        try:
            file = open(rootPath + '/data/test5.json', encoding='utf-8')
            data = json.load(file)
    ...
    def test_PurchaseContract(self):
        ...
        # 定位采购计划第一条记录
              _elementFirst = self.driver.find_element_by_xpath("//*[@id='PurchasePlanDialogWinGridPanelID-body']//tr[@data-recordindex=0]".format(_elementFiveth))
        ...
        first_category = lis[random.randint(0, 0)]
