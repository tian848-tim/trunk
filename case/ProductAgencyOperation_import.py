...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductAgencyOperation_import.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '代运营产品——导入'
        # 脚本标识－ID
        self.script_id = 'ProductAgencyOperation_import'
    ...
    def test_test_vendorcategory(self):
        ...
        # 定位到导入
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationView']//span[contains(@class,'fa-file-text-o')]").click()
        ...
        # 定位到搜索框
        self.driver.find_element_by_xpath("//*[@id='FilesDialogWinSearchPanelID']//input[@name='keywords']").send_keys(ad[0])
