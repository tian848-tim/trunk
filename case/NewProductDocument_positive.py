...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/NewProductDocument_positive.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新品档案——转正'
        # 脚本标识－ID
        self.script_id = 'NewProductDocument_positive'
    ...
    def test_NewProductDocument(self):
        ...
        # 定位到新品档案搜索框
        self.driver.find_element_by_xpath("//*[@id='NewProductDocumentSubFormPanelID']//input[@name='keywords']").send_keys(qw[0])

        sleep(2)

        # 定位到新品档案查询
        self.driver.find_element_by_xpath("//*[@id='NewProductDocumentSubFormPanelID']//span[contains(@class,'fa-search')]").click()
        ...
        # 定位到转正
        self.driver.find_element_by_xpath("//*[@id='NewProductDocumentView']//span[contains(@class,'fa-exchange')]").click()

        sleep(2)

        # 定位到转正
        self.driver.find_element_by_xpath("//*[@id='NewProductDocumentFormCheck']//span[contains(@class,'fa-exchange')]").click()
