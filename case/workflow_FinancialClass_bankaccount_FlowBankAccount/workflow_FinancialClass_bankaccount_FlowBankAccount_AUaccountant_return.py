...
class Refund(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_bankaccount_FlowBankAccount_AUaccountant_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '收款账号变更——AU会计退回'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_bankaccount_FlowBankAccount_AUaccountant_return'
    ...
    def test_flow_balance_refund(self):
        ...
        self.driver.switch_to.frame(self.driver.find_element_by_xpath(
            "//*[@id='FlowBankAccountViewMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowBankAccountForm']//span[contains(@class, 'fa-reply')]").click()
