...
class Refund(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_bankaccount_FlowBankAccount_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '收款账号变更——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_bankaccount_FlowBankAccount_delete'
    ...
    def test_flow_balance_refund(self):
        ...
        # 定位到收款账号变更第一条记录
        self.driver.find_element_by_xpath("//*[@id='FlowBankAccountView']//span[contains(@class,'fa-trash')]").click()
