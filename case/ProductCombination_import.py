...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCombination_import.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品组合关——导入'
        # 脚本标识－ID
        self.script_id = 'ProductCombination_import'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到导入
        self.driver.find_element_by_xpath("//*[@id='ProductCombinationView']//span[contains(@class,'fa-file-text-o')]").click()
