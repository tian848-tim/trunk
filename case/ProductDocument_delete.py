...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductDocument_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品档案——删除'
        # 脚本标识－ID
        self.script_id = 'ProductDocument_delete'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到新品档案删除
        self.driver.find_element_by_xpath("//*[@id='ProductDocumentView']//span[contains(@class,'fa-trash')]").click()
