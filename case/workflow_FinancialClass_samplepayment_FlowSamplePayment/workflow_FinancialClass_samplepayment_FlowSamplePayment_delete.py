...
class FlowSamplePayment(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_samplepayment_FlowSamplePayment_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品付款申请——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_samplepayment_FlowSamplePayment_delete'
    ...
    def test_FlowSamplePayment(self):
        ...
        # 定位到样品付款申请删除
        self.driver.find_element_by_xpath("//*[@id='FlowSamplePaymentView']//span[contains(@class, 'fa-trash')]").click()
