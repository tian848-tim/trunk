...
class FlowSamplePayment(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_samplepayment_FlowSamplePayment_CNaccountant_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品付款申请——CN会计退回'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_samplepayment_FlowSamplePayment_CNaccountant_return'
