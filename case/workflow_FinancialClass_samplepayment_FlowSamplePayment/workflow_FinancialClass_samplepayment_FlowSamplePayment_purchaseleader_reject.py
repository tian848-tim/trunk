...
class FlowSamplePayment(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_samplepayment_FlowSamplePayment_purchaseleader_reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品付款申请——采购组长拒绝'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_samplepayment_FlowSamplePayment_purchaseleader_reject'
    ...
    def test_FlowSamplePayment(self):
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowSamplePaymentMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
