...
class CustomClearance(unittest.TestCase):
    ...
    def test_OrderShippingPlan(self):
        ...
        for i in range(1, len(su)):
            ...
            try:
                self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[i][0])).is_displayed()

                consistent = True

            except:
                print("经理元素不存在:",su[i][0])
