...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/LogisticsDocumentView.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '物流档案'
        # 脚本标识－ID
        self.script_id = 'LogisticsDocumentView'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到服务商档案
        self.driver.find_element_by_xpath("//*[@id='west-panel-targetEl']//span[contains(text(),'物流档案')]").click()

        sleep(3)

        # 定位到服务商档案新建
        self.driver.find_element_by_xpath("//*[@id='LogisticsDocumentView']//span[contains(@class,'fa-plus')]").click()
       ...
       #sleep(3)
        ...
        # 定位到货代名称
        self.driver.find_element_by_xpath("//*[@id='ServiceProviderDocumentFormWinID']//input[@name='main.forwarderName']").click()
        ...
        # 定位到货代名称
        _elementFirst=self.driver.find_element_by_xpath("//*[@id='ForwarderDialogWinID']//div[contains(text(),'{}')]".format(_elementFiveth))
        ...
        # 定位到确定
        #self.driver.find_element_by_xpath("//*[@id='ForwarderDialogWinID']//span[contains(@class,'fa-check')]").click()


        sleep(3)

        # 定位到目的港
        self.driver.find_element_by_xpath("//*[@id='ServiceProviderDocumentFormWinID']//input[@name='main.destinationPort']").click()
