...
class FlowPurchaseContractDeposit(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_AUaccountant_invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购定金申请——AU会计作废'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_AUaccountant_invalid'
    ...
    def test_FlowPurchaseContractDeposit(self):
        ...
        # 定位到作废
        self.driver.find_element_by_xpath("//*[@id='FlowDepositContractForm']//span[contains(@class,'flowcancel')]").click()
