...
class purchaseContractDeposit(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_cashier_review.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购定金申请——出纳返审'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_cashier_review'
    ...
    def test_PurchaseContractDeposit(self):
        ...
        if ad[0] != '':
              ...
              _elementFirst = self.driver.find_element_by_xpath("//*[@id='PurchasePlanDialogWinGridPanelID-body']//tr[@data-recordindex={}]".format('0'))
        ...
        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.depositType']").click()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-list-plain']//li[contains(text(),'固定值')]").click()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.depositRate']").clear()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.depositRate']").send_keys('400')

        sleep(2)


        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.depositAud']").clear()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.depositAud']").send_keys('100')

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.totalOtherAud']").clear()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.totalOtherAud']").send_keys('200')

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.totalOtherDepositAud']").clear()

        sleep(2)

        self.driver.find_element_by_xpath("//*[@class='x-form-trigger-input-cell']//input[@name='main.totalOtherDepositAud']").send_keys('300')
        ...
        self.driver.find_element_by_xpath(
            "//*[@id='FlowPurchaseContractView']//span[contains(@class,'fa-search')]").click()

        sleep(2)

        try:
            self.driver.find_element_by_xpath(
                "//*[@id='FlowPurchaseContractGridPanelID-body']/div/table/tbody/tr[1]//span[contains(text(), '{}')]".format(
                    '调整申请')).is_displayed()
            a = True
        except:
            a = False
        ...
        if a == True:
            ...
            # 定位到发启按钮
            self.driver.find_element_by_xpath(
                "//*[@role='presentation']//span[contains(@class,'fa-check-square')]").click()
        ...
        # 定位价格
        self.driver.find_element_by_xpath("//*[@class='x-field col-1 x-table-plain x-form-item x-form-type-text x-field-default x-autocontainer-form-item']//input[contains(@class, 'x-form-text')]").clear()
        ...
        # 定位价格
        self.driver.find_element_by_xpath("//*[@class='x-field col-1 x-table-plain x-form-item x-form-type-text x-field-default x-autocontainer-form-item x-form-dirty']//input[contains(@class, 'x-field-default-form-focus')]").send_keys(_elementFiveth)
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowDepositContractMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击返审
        self.driver.find_element_by_xpath("//*[@id='FlowDepositContractForm']//span[contains(@class, 'fa-step-backward')]").click()
