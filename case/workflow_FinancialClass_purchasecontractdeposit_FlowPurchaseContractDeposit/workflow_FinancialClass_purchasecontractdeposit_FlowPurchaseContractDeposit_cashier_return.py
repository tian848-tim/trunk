...
class purchaseContractDeposit(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_cashier_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购定金申请——出纳退回'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_purchasecontractdeposit_FlowPurchaseContractDeposit_cashier_return'
    ...
    def test_PurchaseContractDeposit(self):
        ...
        self.driver.switch_to.frame(self.driver.find_element_by_xpath(
            "//*[@id='FlowDepositContractMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowDepositContractForm']//span[contains(@class, 'fa-reply')]").click()
