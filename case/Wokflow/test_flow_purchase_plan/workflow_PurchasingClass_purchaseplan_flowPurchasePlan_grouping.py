...
class purchasePlan(unittest.TestCase):
    ...
    def variable(self):
        ...
        try:
           global abc,variable
           file = open(rootPath + '/data/'+ "test_productquotation" + time.strftime("%Y-%m-%d") + '.json', encoding='utf-8')
           data = json.load(file)
           ...
           return abc
            ...
            print("test_productquotation" + time.strftime("%Y-%m-%d") + '.json'+"File not found")


    def loadvendername(self):

        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_purchaseplan_flowPurchasePlan_grouping.json', encoding='utf-8')
        data = json.load(file)
    ...
    def CN(self):
        ...
        global cn
        file = open(rootPath + '/data/workflow_PurchasingClass_purchaseplan_flowPurchasePlan_grouping.json',
                    encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购计划-组合'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_purchaseplan_flowPurchasePlan_grouping'
    ...
    def test_PurchasePlan(self):
        ...
        if we[0] != '':
            ...
            if  er[0] != '':
                        ...
                        if variable == True:
                               ...
                               # 定位到供应商选择器关键字输入框
                               self.driver.find_element_by_xpath("//*[@id='FlowProductQuotationDialogWinID']//input[@name='keywords']").send_keys(ty[0])
                               ...
                               ul = self.driver.find_element_by_xpath(
                                   "//*[@id='FlowProductQuotationDialogWinGridPanelID-body']/div/table/tbody")
                              ...
                              # 定位到供应商选择器关键字输入框
                              self.driver.find_element_by_xpath("//*[@id='FlowProductQuotationDialogWinID']//input[@name='keywords']").send_keys(ad[0])
        ...
        #_W = self.driver.find_element_by_xpath("//*[@id='FlowPurchasePlanGridPanelID-body']/div/table/tbody/tr[1]/td[2]/div").text
        ...
        full_path = desktop_path + "test_PurchasePlan" + time.strftime("%Y-%m-%d") + '.json'
