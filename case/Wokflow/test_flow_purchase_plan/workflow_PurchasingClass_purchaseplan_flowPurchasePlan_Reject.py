...
class purchasePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_purchaseplan_flowPurchasePlan_Reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购计划——采购组长拒绝'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_purchaseplan_flowPurchasePlan_Reject'
    ...
    def test_PurchasePlan(self):
        ...
        # 定位到申请单类型
        self.driver.find_element_by_xpath(
            "//*[@id='ReportProductAnalysisFormWinID-body']//input[@value='新品开发申请']").click()
        ...
        try:
            self.driver.find_element_by_xpath("//*[@id='FlowPurchasePlanGridPanelID-body']/div/table/tbody/tr[1]//span[contains(text(), '{}')]".format('调整申请')).is_displayed()
            a = True
        except:
            a = False
        if a == True:
        ...
        if a == True:
            ...
            self.driver.find_element_by_xpath(
                "//*[@id='FlowPurchasePlanFormGridMainTbsPanelID-win-body']//input[@name='flowNextHandlerAccount']").click()
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowPurchasePlanFormGridMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 定位到拒绝按钮
        self.driver.find_element_by_xpath("//*[@id='FlowPurchasePlanForm']//span[contains(@class,'fa-fw fa-window-close')]").click()
