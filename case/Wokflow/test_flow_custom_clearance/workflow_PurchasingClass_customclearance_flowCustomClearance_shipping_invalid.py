...
class CustomClearance(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_customclearance_flowCustomClearance_shipping_invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '清关检查——船务作废'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_customclearance_flowCustomClearance_shipping_invalid'
    ...
    def test_CustomClearance(self):
        ...
        # 点击作废
        self.driver.find_element_by_xpath("//*[@id='FlowCustomClearanceForm']//span[contains(@class, 'flowcancel')]").click()
