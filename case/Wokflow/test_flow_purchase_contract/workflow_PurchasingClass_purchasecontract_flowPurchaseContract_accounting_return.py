...
class purchaseContract(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_purchasecontract_flowPurchaseContract_accounting_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建采购合同——AU会计退回'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_purchasecontract_flowPurchaseContract_accounting_return'
