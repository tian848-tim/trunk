...
class Sample(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_sample_flowSample_search.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品申请——搜索'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_sample_flowSample_search'
    ...
    def test_Sample(self):
        ...
        # 定位搜索关键字
        self.driver.find_element_by_xpath("//*[@id='FlowSampleViewSearchFormPanelID-body']//input[contains(@name,'keywords')]").send_keys(ad[0])

        # 定位查询
        self.driver.find_element_by_xpath("//*[@id='FlowSampleViewSearchFormPanelID-body']//span[contains(@class,'fa-search')]").click()
