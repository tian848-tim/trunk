...
class sample(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_sample_flowSample_Reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品申请——采购组长拒绝'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_sample_flowSample_Reject'
    ...
    def test_Sample(self):
        ...
        # 点击拒绝
        self.driver.find_element_by_xpath("//*[@id='FlowSampleForm']//span[contains(@class, 'fa-window-close')]").click()
