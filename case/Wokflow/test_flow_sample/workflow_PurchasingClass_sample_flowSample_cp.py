...
class NewProduct(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_sample_flowSample_cp.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品申请——复制'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_sample_flowSample_cp'
    ...
    def test_NewProduct(self):
        ...
        # 定位复制按钮
        self.driver.find_element_by_xpath("//*[@id='FlowSampleView']//span[contains(@class, 'fa-copy')]").click()

        sleep(2)

        # 定位保存按钮
        self.driver.find_element_by_xpath("//*[@id='FlowSampleForm']//span[contains(@class, 'fa-save')]").click()
