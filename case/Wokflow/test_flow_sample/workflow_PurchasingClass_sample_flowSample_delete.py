...
class ProductQuotation(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_sample_flowSample_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品申请业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_sample_flowSample_delete'
    ...
    def test_PurchaseContract(self):
        ...
        # 定位删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowSampleView']//span[contains(@class, 'fa-trash')]").click()
