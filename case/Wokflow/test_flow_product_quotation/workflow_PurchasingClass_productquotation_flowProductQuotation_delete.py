...
class ProductQuotation(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        file = open(rootPath + '/data/workflow_PurchasingClass_productquotation_flowProductQuotation_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '采购询价——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_productquotation_flowProductQuotation_delete'
    ...
    def test_ProductQuotation(self):
        ...
        # 定位删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowProductQuotationView']//span[contains(@class, 'fa-trash')]").click()
