...
class ProductQuotation(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        file = open(rootPath + '/data/workflow_PurchasingClass_productquotation_flowProductQuotation_Invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '采购询价—采购组长作废'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_productquotation_flowProductQuotation_Invalid'
    ...
    def test_PurchaseContract(self):
        ...
        # 点击作废
        self.driver.find_element_by_xpath("//*[@id='FlowProductQuotationForm']//span[contains(@class, 'flowcancel')]").click()
