...
class test_flowsample_json(unittest.TestCase):
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '采购询价测试'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_productquotation_flowProductQuotation'
    ...
    def test_productquotation(self):
            ...
            if variable == True:
                ...
                # 定位到关键字
                 self.driver.find_element_by_xpath("//*[@id='VendorDialogWinSearchPanelID-body']//input[@name='keywords']").send_keys(ty[1])
            ...
            while  name == True:
                ...
                if variable == True:
                    ...
                    # 定位到关键字
                    self.driver.find_element_by_xpath(
                        "//*[@id='VendorDialogWinSearchPanelID-body']//input[@name='keywords']").send_keys(ty[1])
                    ...
                    _elementFirst = self.driver.find_element_by_xpath(
                        "//*[@id='VendorDialogWinGridPanelID-body']//div[text()='1']")
            ...
            if variable == True:
                ...
                # 定位到关键字
                self.driver.find_element_by_xpath("//*[@id='ProductDialogWinID-body']//input[@name='keywords']").send_keys(ty[0])

                # 强制等待
                sleep(2)

                # 点击搜索
                self.driver.find_element_by_xpath("//*[@id='ProductDialogWinID-body']//span[contains(@class,'fa-search')]").click()

                # 强制等待
                sleep(2)

                # 定位采购第一条记录
                _elementFirst = self.driver.find_element_by_xpath("//*[@id='ProductDialogWinGridPanelID-body']//div[text()='1']")
