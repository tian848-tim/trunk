...
class NewProduct(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_newproduct_flowNewProduct_return_GM.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新品开发——采购经理退回'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_newproduct_flowNewProduct_return_GM'
    ...
    def test_NewProduct(self):
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowNewProductForm']//span[contains(@class, 'fa-fw fa-reply')]").click()
