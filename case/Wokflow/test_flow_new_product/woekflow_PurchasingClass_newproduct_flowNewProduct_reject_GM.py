...
class NewProduct(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/woekflow_PurchasingClass_newproduct_flowNewProduct_reject_GM.json', encoding='utf-8')
        data = json.load(file)
    ...
    def test_NewProduct(self):
        ...
        if  _T == 'Jack.L / Jack.L / Jack.L':
              ...
              self.driver.switch_to.frame(self.driver.find_element_by_xpath(
                  "//*[@id='FlowNewProductViewMainTabsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
              ...
              # 点击拒绝
              self.driver.find_element_by_xpath(
                  "//*[@id='FlowNewProductForm']//span[contains(@class, 'x-btn-icon-el fa fa-fw fa-window-close')]").click()
