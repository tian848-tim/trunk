...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/Tariff_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '海关编码——删除'
        # 脚本标识－ID
        self.script_id = 'Tariff_delete'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到删除
        self.driver.find_element_by_xpath("//*[@id='TariffView']//span[contains(@class,'fa-trash')]").click()
