'''
测试用例标题：产品认证测试
测试场景：产品认证申请业务流程测试——安检组长——安检报告——退回
创建者：Tim
创建日期：2018-11-5
最后修改日期：2018-11-5
输入数据：审批流程各个角色账号
...
class OrderQc(unittest.TestCase):
    ...
    def test_Order_Qc(self):
        ...
        self.driver.find_element_by_xpath(
            "//*[@id='FlowProductCertificationView']//span[contains(@class,'fa-plus')]").click()

        sleep(2)

        ## 选择供应商
        self.driver.find_element_by_xpath(
            "//*[@id='FlowProductCertificationFormPanelID']//input[@name='main.vendorName']").click()

        sleep(2)

        ## 定位到关键字
        self.driver.find_element_by_xpath(
            "//*[@id='VendorDialogWinSearchPanelID-innerCt']//input[@name='keywords']").send_keys('搭')
        ...
        _elementSecond = self.driver.find_element_by_xpath(
            "//*[@id='FlowProductCertificationFormGridPanelID']//img[contains(@class,'x-tool-plus')]")
        ...
        _elementThird = self.driver.find_element_by_xpath(
            "//*[@id='ProductDialogWinGridPanelID-center']//div[contains(text(), '1')]")
        ...
        # 点击发启
        self.driver.find_element_by_xpath(
            "//*[@id='FlowProductCertificationForm']//span[contains(@class,'fa-play')]").click()
...
#        # 分配处理人
#        self.driver.find_element_by_xpath(
#            "//*[@id='FlowProductCertificationMainTbsPanelID-win-body']//input[@name='flowNextHandlerAccount']").click()
#
#        sleep(2)
#
#        # 选择
...
#        # 点击通过
#        self.driver.find_element_by_xpath(
#            "//*[@id='FlowProductCertificationForm']//span[contains(@class, 'fa-check-square')]").click()
#
#        sleep(8)
#
#        self.driver.find_element_by_link_text('注销').click()  # 点击注销
...
#
        ...
        # 定位到产品证书档案新建
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCertificateDocumentView']//span[contains(@class,'fa-plus')]").click()

        sleep(2)

        # 定位到应用ID
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCertificateDocumentViewFormPanelID-body']//input[@name='main_businessId']").click()

        sleep(2)

        # 定位第申请器第一条记录
        _elementeight = self.driver.find_element_by_xpath(
        ...
        # 定位到证书文件输入框
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCertificateDocumentViewFormPanelID-body']//input[@name='main.fileName']").click()

        sleep(2)

        # 定位文件选择器第一条记录
        _elementseven = self.driver.find_element_by_xpath(
        ...
        # 定位到描述
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCertificateDocumentViewFormPanelID-body']//textarea[@name='description']").send_keys(
            _elementFiveth)
        ...
        # 定位到保存按钮
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCertificateDocumentForm']//span[contains(@class,'fa-save')]").click()
        ...
        self.driver.switch_to.frame(self.driver.find_element_by_xpath(
            "//*[@id='FlowProductCertificationMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowProductCertificationForm']//span[contains(@class, 'fa-reply')]").click()
