...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/NewProductDocument_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新品档案——复制'
        # 脚本标识－ID
        self.script_id = 'NewProductDocument_copy'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到新品档案复制
        self.driver.find_element_by_xpath("//*[@id='NewProductDocumentView']//span[contains(@class,'fa-copy')]").click()
