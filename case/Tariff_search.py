...
class ProductCategory(unittest.TestCase):
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '海关编码——搜索'
        # 脚本标识－ID
        self.script_id = 'Tariff_search'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到搜索框
        self.driver.find_element_by_xpath("//*[@id='TariffSearchFormPanelID']//input[contains(@class,'x-form-text')]").send_keys(ad[0])

        sleep(2)


        # 定位到查询
        self.driver.find_element_by_xpath("//*[@id='TariffSearchFormPanelID']//span[contains(@class,'fa-search')]").click()

        sleep(2)

        # 定位到搜索框
        test = self.driver.find_element_by_xpath("//*[@id='TariffMainGridPanelID-body']/div/table/tbody/tr[1]/td[2]/div").text
        ...
        full_path = desktop_path + "test_ProductCategory"+time.strftime("%Y-%m-%d")+ '.json'
