...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCertificateDocument.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品证书'
        # 脚本标识－ID
        self.script_id = 'ProductCertificateDocument'
    ...
    def test_ProductCategory(self):
        ...
        if ad[0] != '':
            ...
            # 定位到选择
            self.driver.find_element_by_xpath("//*[@id='VendorDialogWinGridPanelID-body']//div[text()='{}']".format(_elementFiveth)).click()
        ...
        # 定位到启用
        self.driver.find_element_by_xpath("//*[@id='ProductCertificateDocumentView']//span[contains(@class,'fa-location-arrow')]").click()
