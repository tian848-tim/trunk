...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/Tariff_edit.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '海关编码——编辑'
        # 脚本标识－ID
        self.script_id = 'Tariff_edit'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品档案
        self.driver.find_element_by_xpath("//*[@id='west-panel-body']//span[contains(text(),'产品档案')]").click()
        ...
        # 定位到海关编码
        self.driver.find_element_by_xpath("//*[@id='TariffFormPanelID']//input[@name='main.itemCode']").clear()
        ...
        self.driver.find_element_by_xpath("//*[@id='TariffFormPanelID']//input[@name='main.dutyRate']").clear()
