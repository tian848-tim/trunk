...
class CustomClearance(unittest.TestCase):
    ...
    def login(self, username, password):
        self.driver.get('http://192.168.1.118:880/')  # 登录页面
        self.driver.find_element_by_id('account-inputEl').send_keys(username)
        self.driver.find_element_by_id('password-inputEl').send_keys(password)


        #ul = self.driver.find_element_by_xpath("//*[@id='loginTypeGroup-innerCt']//input[contains(@class,'x-form-field x-form-radio x-form-cb')]")[0]

        try:

            self.driver.find_element_by_xpath( "//*[@id='LoginWin-body']//input[@class = 'x-form-field x-form-radio x-form-cb']").is_displayed()
            a = True
        ...
        self.driver.find_elements_by_xpath( "//*[@id='LoginWin-body']//input[@class = 'x-form-field x-form-radio x-form-cb']")[1].click()
        ...
        # 在此元素上双击
        #ActionChains(self.driver).double_click(first_category).perform()
    ...
    def test_CustomClearance(self):
        ...
        _elementSecond = self.driver.find_element_by_xpath("//*[@id='OrderDialogWinGridPanelID-body']/div/table/tbody/tr[{}]/td[18]/div".format(_elementFiveth)).get_attribute('textContent')
