...
class ProductCategory(unittest.TestCase):
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '问题记录——编辑'
        # 脚本标识－ID
        self.script_id = 'ProductProblem_edit'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到问题记录编辑
        self.driver.find_element_by_xpath("//*[@id='ProductProblemView']//span[contains(@class,'fa-pencil-square-o')]").click()
        ...
        # 定位到邮箱
        self.driver.find_element_by_xpath("//*[@id='ProductProblemFormPanelID-body']//input[@name='main.email']").send_keys("DFG",_elementFiveth,"@qq.com")
