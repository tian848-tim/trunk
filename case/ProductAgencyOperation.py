...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductAgencyOperation.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '代运营产品'
        # 脚本标识－ID
        self.script_id = 'ProductAgencyOperation'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品证书档案新建
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationView']//span[contains(@class,'fa-plus')]").click()

        sleep(3)

        # 定位到货主
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationFormPanelID']//div[contains(@class,'x-form-trigger-first')]").click()

        sleep(3)


        # 定位到货主
        self.driver.find_element_by_xpath("//*[@class='x-list-plain']//li[contains(text(),'Hunt')]").click()
        ...
        # 定位到启用
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationView']//span[contains(@clas,'fa-location-arrow')]").click()
