...
class FeeRegister(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_feepayment_FlowFeePayment_AUaccountant_review.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '费用支付——AU会计返审'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_feepayment_FlowFeePayment_AUaccountant_review'
    ...
    def test_flow_fee_register(self):
        ...
        self.driver.find_element_by_xpath(
            "//*[@id='FlowFeePaymentFormPanelID-body']//input[@name='main.feeRegistrationName']").click()

        sleep(1)

        try:
            self.driver.find_element_by_xpath(
                "//*[@id='FeeRegistrationDialogWinID']//div[contains(text(),'{}')]".format('没有数据！')).is_displayed()
            a = True
        except:
            a = False
        ...
        if a == True:
            self.driver.find_element_by_xpath(
                "//*[@id='FeeRegistrationDialogWinID']//img[contains(@class,'x-tool-close')]").click()
            ...
            # 定位到费用登记新建
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeeRegistrationView']//span[contains(@class,'fa-plus')]").click()

            sleep(2)

            ## 选择费用类型
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeeRegistrationFormPanelID-body']//input[@name='main.feeType']").click()
            ...
            ## 选择订单编号
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeeRegistrationFormPanelID-orderContainer-innerCt']//input[@name='main.orderNumber']").click()
            ...
            # 定位到发启按钮
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeeRegistrationForm']//span[contains(@class,'fa-play')]").click()
        ...
        if ad[0] != '':
            ...
            self.driver.find_element_by_xpath(
                "//*[@id='FeeRegistrationDialogWinID']//input[@name='keywords]").send_keys(ad[0])

            sleep(2)

            self.driver.find_element_by_xpath(
                "//*[@id='FeeRegistrationDialogWinID']//span[contains(@class, 'fa-search')]")

            sleep(2)

            # 定位采购第一条记录
            _elementFirst = self.driver.find_element_by_xpath(
                "//*[@id='FeeRegistrationDialogWinGridPanelID']//div[contains(text(), '1')]")
        ...
        try:
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeePaymentGridPanelID-body']/div/table/tbody/tr[1]//span[contains(text(), '{}')]".format(
                    '调整申请')).is_displayed()
            a = True
        except:
            a = False
        ...
        if a == True:
            ...
            # 定位到发启按钮
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeePaymentForm']//span[contains(@class,'fa-check-square')]").click()
        ...
        try:
            self.driver.find_element_by_xpath(
                "//*[@id='FlowFeePaymentGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(
                    su[3][0])).is_displayed()
            a = True
        except:
            a = False
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowFeePaymentMainTabsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击返审
        self.driver.find_element_by_xpath("//*[@id='FlowFeePaymentForm']//span[contains(@class, 'fa-step-backward')]").click()
