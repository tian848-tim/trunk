...
class FlowAsn(unittest.TestCase):
    ...
    def variable(self):
        ...
        try:
            global ABC,variable
            file = open(rootPath + '/data/'+ "test_ProductCost" + time.strftime("%Y-%m-%d") + '.json', encoding='utf-8')
            data = json.load(file)
            ...
            print("test_ProductCost" + time.strftime("%Y-%m-%d") + '.json'+"File not found")
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_asn_FlowAsn_grouping.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '收货通知-组合'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_asn_FlowAsn_grouping'
    ...
    def test_FlowAsn(self):
        ...
        if  variable == True:
            ...
            # 点击发启
            self.driver.find_element_by_xpath("//*[@id='WarehousePlanningDialogWinID-body']//input[contains(@name,'keywords')]").send_keys(we[0])

            sleep(2)

            self.driver.find_element_by_xpath("//*[@id='WarehousePlanningDialogWinID-body']//span[contains(@class,'fa-search')]").click()
            ...
            ul = self.driver.find_element_by_xpath("//*[@id='WarehousePlanningDialogWinGridPanelID-body']/div/table/tbody")
        ...
        # 点击发启
        self.driver.find_element_by_xpath("//*[@id='FlowOrderReceivingNoticeForm']//span[contains(@class,'fa-play')]").click()
        ...
        # 点击通过
        self.driver.find_element_by_xpath("//*[@id='FlowOrderReceivingNoticeForm']//span[contains(@class, 'fa-check-square')]").click()
