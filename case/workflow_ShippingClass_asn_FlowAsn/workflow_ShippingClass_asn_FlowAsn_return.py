...
class FlowAsn(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_asn_FlowAsn_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '收货通知——退回'
        # 脚本标识－ID
        self.script_id = 'FlowAsn_return'
    ...
    def test_FlowAsn(self):
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowOrderReceivingNoticeForm']//span[contains(@class, 'fa-reply')]").click()
