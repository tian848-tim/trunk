...
class FlowAsn(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_asn_FlowAsn_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '收货通知——复制'
        # 脚本标识－ID
        self.script_id = 'FlowAsn_copy'
    ...
    def test_FlowAsn(self):
        ...
        # 定位到收货通知复制
        self.driver.find_element_by_xpath("//*[@id='FlowOrderReceivingNoticeView']//span[contains(@class, 'fa-copy')]").click()
