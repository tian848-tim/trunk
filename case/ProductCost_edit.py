...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCost_edit.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '成本计算——编辑'
        # 脚本标识－ID
        self.script_id = 'ProductCost_edit'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到编辑
        self.driver.find_element_by_xpath("//*[@id='ProductCostView']//span[contains(@class,'fa-pencil-square-o')]").click()
        ...
        self.driver.find_element_by_xpath(
            "//*[@id='ProductCostViewFormPanelID']//div[contains(@class,'x-form-trigger-first')]").click()
        ...
        if ad[0] != '':
            ...
            # 定位到发货计划编号
            self.driver.find_element_by_xpath(
                "//*[@id='OrderShippingPlanDialogWinID']//div[@name='keywords']").send_keys(ad[0])

            sleep(2)

            self.driver.find_element_by_xpath(
                "//*[@id='OrderShippingPlanDialogWinID']//span[contains(@class,'fa-search')]").click()

            sleep(2)

            self.driver.find_element_by_xpath(
                "//*[@id='OrderShippingPlanDialogWinGridPanelID-body']//div[contains(text(),'1')]").click()
            ...
            # 定位到发货计划
            self.driver.find_element_by_xpath(
                "//*[@id='OrderShippingPlanDialogWinGridPanelID-body']//tr[@data-recordindex={}]".format(
                    _elementFiveth)).click()

        sleep(3)

        # 定位到确认
        self.driver.find_element_by_xpath(
            "//*[@id='OrderShippingPlanDialogWinID']//span[contains(@class,'fa-check')]").click()
