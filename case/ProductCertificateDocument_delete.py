...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCertificateDocument_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品证书——删除'
        # 脚本标识－ID
        self.script_id = 'ProductCertificateDocument_delete'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品证书档案删除
        self.driver.find_element_by_xpath("//*[@id='ProductCertificateDocumentView']//span[contains(@class,'fa-trash')]").click()
