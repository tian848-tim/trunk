...
class ChangeOwnership(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_changeownership_flowChangeOwnership_Retrial.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '归属权变更业务流程测试——经理返审'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_changeownership_flowChangeOwnership_Retrial'
    ...
    def test_ChangeOwnership(self):
        ...
        #定位返审
        self.driver.find_element_by_xpath("//*[@id='FlowChangeOwnershipForm']//span[contains(@class, 'fa-step-backward')]").click()
