...
class ChangeOwnership(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_changeownership_flowChangeOwnership_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '归属权变更业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_changeownership_flowChangeOwnership_delete'
    ...
    def test_ChangeOwnership(self):
        ...
        #定位保存
        self.driver.find_element_by_xpath("//*[@id='FlowChangeOwnershipForm']//span[contains(@class, 'fa-save')]").click()
        ...
        #定位删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowChangeOwnershipView']//span[contains(@class, 'fa-trash')]").click()
