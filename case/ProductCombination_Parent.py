...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCombination_Parent.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品组合关系——Parent'
        # 脚本标识－ID
        self.script_id = 'ProductCombination_Parent'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到产品类型
        self.driver.find_element_by_xpath("//*[@id='ProductCombinationFormWinID-body']//input[contains(@class,'x-trigger-noedit')]").click()

        sleep(3)

        # 定位到产品类型
        self.driver.find_element_by_xpath("//*[@class='x-list-plain']//li[contains(text(),'Var. Parent SKU')]").click()
        ...
        # 定位到采购员
        self.driver.find_element_by_xpath("//*[@id='ProductCombinationFormWinID-body']//input[contains(@class,'x-form-text')]").click()


        sleep(3)

        _elementFiveth = (random.randint(0, 50))

        #定位到选择
        _N = self.driver.find_element_by_xpath("//*[@id='UserDialogWinGridPanelID-body']//tr[@data-recordindex={}]".format(_elementFiveth))
...
#
        ## 定位到关键字
        #self.driver.find_element_by_xpath("//*[@id='ProductDialogWinSearchPanelID-body']//input[@name='keywords']").send_keys("飞亚家具有限公司")
#
        #sleep(3)
#
        ## 定位到查询
