...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductOwnerManage_edit.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '货主管理——编辑'
        # 脚本标识－ID
        self.script_id = 'ProductOwnerManage_edit'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到货主管理第一条记录
        self.driver.find_element_by_xpath("//*[@id='ProductOwnerManageGridPanelID-body']//div[contains(text(),'1')]").click()

        sleep(2)

        # 定位到货主管理编辑
        self.driver.find_element_by_xpath("//*[@id='ProductOwnerManageView']//span[contains(@class,'fa-pencil-square-o')]").click()
