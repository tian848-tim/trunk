...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/vendorcategory_edit.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '新建供应商分类——编辑'
        # 脚本标识－ID
        self.script_id = 'vendorcategory_edit'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到编辑供应商按钮
        self.driver.find_element_by_xpath("//*[@id='VendorCategoryViewPanelID']//span[contains(@class,'fa-pencil-square-o')]").click()
        ...
        # 定位到英文名称测试
        self.driver.find_element_by_xpath("//*[@id='VendorCategoryViewFormPanelId-body']//input[@name='main.enName']").send_keys(_KT,_S)
