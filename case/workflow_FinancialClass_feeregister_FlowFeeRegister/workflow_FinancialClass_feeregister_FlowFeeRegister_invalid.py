...
class FeeRegister(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_feeregister_FlowFeeRegister_invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－标题
        self.script_name = '费用登记——作废'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_feeregister_FlowFeeRegister_invalid'
    ...
    def test_flow_fee_register(self):
        ...
        # 定位到费用登记申请编辑
        self.driver.find_element_by_xpath("//*[@id='FlowFeePaymentView']//span[contains(@class, 'x-btn-inner-center')]").click()

        sleep(2)

        # 定位到作废按钮
        self.driver.find_element_by_xpath("//*[@id='centerTabPanel-body']//span[contains(@class, 'flowcancel')]").click()
