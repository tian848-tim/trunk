...
class FeeRegister(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_feeregister_FlowFeeRegister_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－标题
        self.script_name = '费用登记——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_feeregister_FlowFeeRegister_delete'
    ...
    def test_flow_fee_register(self):
        ...
        # 定位到删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowFeeRegistrationView']//span[contains(@class,'fa-trash')]").click()
