...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCost_search.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '成本计算——搜索'
        # 脚本标识－ID
        self.script_id = 'ProductCost_search'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到搜索框
        self.driver.find_element_by_xpath("//*[@id='ProductCostViewSubFormPanelID']//input[contains(@class,'x-form-text')]").send_keys(ad[0])

        sleep(3)

        # 定位到搜索框
        self.driver.find_element_by_xpath("//*[@id='ProductCostViewSubFormPanelID']//input[contains(@class,'fa-search')]").click()
