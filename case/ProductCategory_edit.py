...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCategory_edit.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品分类——编辑'
        # 脚本标识－ID
        self.script_id = 'ProductCategory_edit'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品分类编辑
        self.driver.find_element_by_xpath("//*[@id='ProductCategoryView-body']//span[contains(@class,'fa-pencil-square-o')]").click()
