...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductAgencyOperation_search.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '代运营产品——搜索'
        # 脚本标识－ID
        self.script_id = 'ProductAgencyOperation_search'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品证书档案搜索框
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationSubFormPanelID']//input[@name='keywords']").send_keys(ad[0])

        sleep(3)


        # 定位到产品证书档案查询
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationSubFormPanelID']//span[contains(@class,'fa-search')]").click()
