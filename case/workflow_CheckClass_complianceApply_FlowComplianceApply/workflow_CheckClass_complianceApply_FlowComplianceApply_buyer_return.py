...
class complianceApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceApply_FlowComplianceApply_buyer_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        #脚本标识-标题
        self.script_name ='安检申请流程正常审批——采购员退回'
        #脚本标识-ID
        self.script_id ='workflow_CheckClass_complianceApply_FlowComplianceApply_buyer_return'
