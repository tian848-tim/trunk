...
class complianceApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceApply_FlowComplianceApply_buyer_reject.json', encoding='utf-8')
        data = json.load(file)
