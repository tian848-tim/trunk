...
class complianceApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceApply_FlowComplianceApply_GM_retrial.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        #脚本标识-标题
        self.script_name ='安检申请流程正常审批——经理返审'
        #脚本标识-ID
        self.script_id ='workflow_CheckClass_complianceApply_FlowComplianceApply_GM_retrial'
    ...
    def test_flow_compliance_apply(self):
        ...
        # 定位返审按钮
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementForm']//span[contains(@class, 'fa-step-backward')]").click()
