...
class ProductLine(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_productline_FlowProductLine_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '开设产品线业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_productline_FlowProductLine_delete'
    ...
    def test_ProductLine(self):
        ...
        #定位保存
        self.driver.find_element_by_xpath("//*[@id='FlowProductLineForm']//span[contains(@class, 'fa-fw fa-save')]").click()
        ...
        #定位删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowProductLineView']//span[contains(@class, 'fa-trash')]").click()
