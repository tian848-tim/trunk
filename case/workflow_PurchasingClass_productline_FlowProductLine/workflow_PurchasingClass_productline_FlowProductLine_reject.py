...
class ProductLine(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_PurchasingClass_productline_FlowProductLine_reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '开设产品线业务流程测试——经理拒绝'
        # 脚本标识－ID
        self.script_id = 'workflow_PurchasingClass_productline_FlowProductLine_reject'
    ...
    def test_ProductLine(self):
        ...
        #定位拒绝
        self.driver.find_element_by_xpath("//*[@id='FlowProductLineForm']//span[contains(@class, 'fa-window-close')]").click()
