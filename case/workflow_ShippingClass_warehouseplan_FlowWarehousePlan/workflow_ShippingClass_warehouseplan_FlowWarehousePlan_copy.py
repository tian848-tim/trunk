...
class FlowWarehousePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_warehouseplan_FlowWarehousePlan_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '送仓计划——复制'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_warehouseplan_FlowWarehousePlan_copy'
    ...
    def test_FlowWarehousePlan(self):
        ...
        # 定位到送仓计划复制
        self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningView']//span[contains(@class, 'fa-copy')]").click()
