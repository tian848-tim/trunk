...
class FlowWarehousePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_warehouseplan_FlowWarehousePlan_reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '送仓计划——拒绝'
        # 脚本标识－ID
        self.script_id = 'FlowWarehousePlan_reject'
    ...
    def test_FlowWarehousePlan(self):
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningMainTabsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击拒绝
        self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningForm']//span[contains(@class, 'fa-window-close')]").click()
