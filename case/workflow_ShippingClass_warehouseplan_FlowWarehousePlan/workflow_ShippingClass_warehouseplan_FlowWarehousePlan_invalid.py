...
class FlowWarehousePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_warehouseplan_FlowWarehousePlan_invalid.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '送仓计划——作废'
        # 脚本标识－ID
        self.script_id = 'FlowWarehousePlan_invalid'
    ...
    def test_FlowWarehousePlan(self):
        ...
        # 点击作废
        self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningForm']//span[contains(@class, 'flowcancel')]").click()
