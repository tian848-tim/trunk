...
class FlowWarehousePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_warehouseplan_FlowWarehousePlan_grouping.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '送仓计划-组合'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_warehouseplan_FlowWarehousePlan_grouping'
    ...
    def test_FlowWarehousePlan(self):
        ...
        if variable == True:
            ...
            # 点击确认
             self.driver.find_element_by_xpath("//*[@id='PackingListDialogWinID']//input[contains(@name,'keywords')]").send_keys(we[0])

             sleep(2)

            # 点击确认
             self.driver.find_element_by_xpath("//*[@id='PackingListDialogWinID-body']//span[contains(@class,'fa-search')]").click()
        ...
        #_W = self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningGridPanelID-body']/div/table/tbody/tr[1]/td[4]/div").text

        ul = self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningGridPanelID-body']/div/table/tbody/tr[1]")
        ...
        full_path = desktop_path + "test_FlowWarehousePlan" + time.strftime("%Y-%m-%d") + '.json'
