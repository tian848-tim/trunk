...
class FlowWarehousePlan(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_warehouseplan_FlowWarehousePlan_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '送仓计划——退回'
        # 脚本标识－ID
        self.script_id = 'FlowWarehousePlan_return'
    ...
    def test_FlowWarehousePlan(self):
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowWarehousePlanningForm']//span[contains(@class, 'fa-reply')]").click()
