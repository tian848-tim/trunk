...
测试用例
'''
class ProductProblem_copy(unittest.TestCase):
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '问题记录——复制'
        # 脚本标识－ID
        self.script_id = 'ProductProblem_copy'
    ...
    def test_ProductProblem_copy(self):
        ...
        # 定位到问题记录复制
        self.driver.find_element_by_xpath("//*[@id='ProductProblemView']//span[contains(@class,'fa-copy')]").click()
