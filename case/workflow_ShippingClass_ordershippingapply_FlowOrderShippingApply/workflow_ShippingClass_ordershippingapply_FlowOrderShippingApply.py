...
class FlowOrderShippingApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply'
