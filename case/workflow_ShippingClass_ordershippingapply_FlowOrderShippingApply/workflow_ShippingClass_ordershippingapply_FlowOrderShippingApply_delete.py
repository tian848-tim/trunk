...
class OrderShippingApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货确认——删除'
        # 脚本标识－ID
        self.script_id = 'FlowOrderShippingApply_delete'
    ...
    def test_FlowOrderShippingApply(self):
        ...
        # 定位到订单发货确认删除
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingConfirmationView']//span[contains(@class, 'fa-trash')]").click()
