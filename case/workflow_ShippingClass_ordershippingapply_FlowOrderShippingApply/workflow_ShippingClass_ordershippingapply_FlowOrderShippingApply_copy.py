...
class FlowOrderShippingApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货确认——复制'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply_copy'
    ...
    def test_FlowOrderShippingApply(self):
        ...
        # 定位到订单发货确认复制
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingConfirmationView']//span[contains(@class, 'fa-copy')]").click()

        sleep(2)

        # 点击保存
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingConfirmationForm']//span[contains(@class,'fa-save')]").click()
