...
class FlowOrderShippingApply(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingapply_FlowOrderShippingApply_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货确认——采购经理退回'
        # 脚本标识－ID
        self.script_id = 'FlowOrderShippingApply_return'
    ...
    def test_FlowOrderShippingApply(self):
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingConfirmationForm']//span[contains(@class, 'fa-reply')]").click()
