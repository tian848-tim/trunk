...
class ComplianceExtend(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceextend_flowComplianceExtend_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = 'SKU拓展安检申请业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_complianceextend_flowComplianceExtend_delete'
    ...
    def test_Compliance_Extend(self):
        ...
        # 点击保存
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementExtendForm']//span[contains(@class,'fa-save')]").click()
        ...
        # 定位到删除按钮
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementExtendView']//span[contains(@class, 'fa-trash')]").click()
