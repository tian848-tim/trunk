...
class ComplianceExtend(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceextend_flowComplianceExtend_security_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = 'SKU拓展安检申请业务流程测试——安检组长退回'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_complianceextend_flowComplianceExtend_security_return'
    ...
    def test_Compliance_Extend(self):
        ...
        while a == True :
            ...
            try:
                self.driver.find_element_by_xpath(
                    "//*[@id='ProductDialogWinID']//div[contains(text(),'{}')]".format('没有数据！')).is_displayed()
                a = True
            except:
                a = False
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementExtendMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击退回
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementExtendForm']//span[contains(@class, 'fa-reply')]").click()
