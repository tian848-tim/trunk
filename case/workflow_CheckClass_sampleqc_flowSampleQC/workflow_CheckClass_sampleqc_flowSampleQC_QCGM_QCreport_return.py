...
class sample(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_sampleqc_flowSampleQC_QCGM_QCreport_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品检验申请业务流程测试——质检经理质检报告退回'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_sampleqc_flowSampleQC_QCGM_QCreport_return'
