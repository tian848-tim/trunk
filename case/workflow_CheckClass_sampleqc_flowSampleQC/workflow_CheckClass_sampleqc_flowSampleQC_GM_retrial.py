...
class sample(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_sampleqc_flowSampleQC_GM_retrial.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '样品检验申请业务流程测试——采购经理返审'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_sampleqc_flowSampleQC_GM_retrial'
    ...
    def test_SampleQc(self):
        ...
        _elementThird = self.driver.find_element_by_xpath(
            "//*[@id='ProductDialogWinGridPanelID-body']//div[text()='{}']".format(_elementFiveth))
        ...
        try:
            self.driver.find_element_by_xpath(
                "//*[@id='FlowSampleQcGridPanelID-body']/div/table/tbody/tr[1]//span[contains(text(), '{}')]".format(
                    '调整申请')).is_displayed()
            a = True
        except:
            a = False
        ...
        if a == True:
            ...
            # 定位到发启按钮
            self.driver.find_element_by_xpath(
                "//*[@id='FlowSampleQcForm']//span[contains(@class,'fa-check-square')]").click()
        ...
        # 定位样品检验报告新建
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionView']//span[contains(@class,'fa-plus')]").click()

        sleep(2)

        # 定位到应用ID
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionFormWinID-body']//input[@name='main_businessId']").click()
        ...
        # 定位到报告标题
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionFormWinID-body']//input[@name='main.title']").send_keys(_elementFiveth)
        ...
        # 定位到报告编号
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionFormWinID-body']//input[@name='main.serialNumber']").send_keys(
            _elementFiveth)
        ...
        # 定位到报告文件
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionFormWinID-body']//input[@name='reportFileDocumentName']").click()

        sleep(2)

        # 定位第文件选择申请器第一条记录
        _elementFivth = self.driver.find_element_by_xpath(
        ...
        # 定位到保存按钮
        self.driver.find_element_by_xpath(
            "//*[@id='ReportSampleInspectionFormWinID']//span[contains(@class,'fa-save')]").click()
        ...
        # 定位iframe
        self.driver.switch_to.frame(self.driver.find_element_by_xpath("//*[@id='FlowSampleQcMainTbsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击返审
        self.driver.find_element_by_xpath("//*[@id='FlowSampleQcForm']//span[contains(@class, 'fa-step-backward')]").click()
