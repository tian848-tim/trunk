...
class ComplianceExtend(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = 'SKU风控级别变更'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick'
    ...
    def test_Compliance_Extend(self):
        ...
        while (a == True) :
            ...
            # 定位到供应商名称
            self.driver.find_element_by_xpath(
                "//*[@id='FlowComplianceArrangementQuickViewFormPanelID-body']//input[@name='main.vendorName']").click()
            ...
            if ad[0] != '':
                ...
                # 定位到关键字
                self.driver.find_element_by_xpath(
                    "//*[@id='VendorDialogWinSearchPanelID-body']//input[contains(@class, 'x-form-text')]").send_keys(
                    ad[0])
                ...
                # 定位到查询
                self.driver.find_element_by_xpath(
                    "//*[@id='VendorDialogWinSearchPanelID-body']//span[contains(@class, 'fa-search')]").click()
            ...
            # 定位到插入
            _elementFourth = self.driver.find_element_by_xpath(
                "//*[@id='FlowComplianceArrangementQuickFormGridPanelID_header-body']//img[contains(@class, 'x-tool-plus')]")
