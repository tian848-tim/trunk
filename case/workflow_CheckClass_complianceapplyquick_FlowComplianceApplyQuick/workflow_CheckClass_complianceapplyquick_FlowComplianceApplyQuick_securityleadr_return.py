...
class ComplianceExtend(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick_securityleadr_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = 'SKU风控级别变更业务流程测试——安检组长退回'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick_securityleadr_return'
    ...
    def test_Compliance_Extend(self):
        ...
        # 点击拒绝
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementQuickForm']//span[contains(@class, 'fa-reply')]").click()
