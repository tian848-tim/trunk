...
class ComplianceExtend(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = 'SKU风控级别变更业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_CheckClass_complianceapplyquick_FlowComplianceApplyQuick_delete'
    ...
    def test_Compliance_Extend(self):
        ...
        # 定位到删除
        self.driver.find_element_by_xpath("//*[@id='FlowComplianceArrangementQuickView']//span[contains(@class, 'fa-trash')]").click()
