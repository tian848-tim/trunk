...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/VendorProductLine.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        ...
        # 脚本标识－ID
        self.script_id = 'VendorProductLine'
    ...
    def test_vendorcategory(self):
        ...
        # 定位到供应商产品线搜索框
        self.driver.find_element_by_xpath("//*[@id='VendorProductLineSubFormPanlID']//input[contains(@class,'x-form-text')]").send_keys(ad[0])

        sleep(2)

        # 定位到供应商产品线查询
        self.driver.find_element_by_xpath("//*[@id='VendorProductLineSubFormPanlID']//span[contains(@class,'fa-search')]").click()
