...
class OrderQc(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheakClass_orderqc_flowOrderQC_grouping.json', encoding='utf-8')
        data = json.load(file)
    ...
    def CN(self):
        ...
        global cn
        file = open(rootPath + '/data/workflow_CheakClass_orderqc_flowOrderQC_grouping.json',
                    encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单质检-组合'
        # 脚本标识－ID
        self.script_id = 'workflow_CheakClass_orderqc_flowOrderQC_grouping'
    ...
    def test_Order_Qc(self):
        ...
        # 检查元素是否存在
        _NoData = self.driver.find_element_by_xpath("//div[@id='FlowPurchaseContractGridPanelID-body']/div/table/tbody/tr[1]").text
        ...
        if _value == su[3][0]:
            ...
            # 定位到订单质检申请
            self.driver.find_element_by_xpath(
                "//*[@id='west-panel-targetEl']//span[text() = '{}']".format(lg[2])).click()
