...
class OrderQc(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_CheakClass_orderqc_flowOrderQC_GM_return.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单质检——采购经理退回'
        # 脚本标识－ID
        self.script_id = 'workflow_CheakClass_orderqc_flowOrderQC_GM_return'
