...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductAgencyOperation_copy.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '代运营产品——复制'
        # 脚本标识－ID
        self.script_id = 'ProductAgencyOperation_copy'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品证书档案复制
        self.driver.find_element_by_xpath("//*[@id='ProductAgencyOperationView']//span[contains(@class,'fa-copy')]").click()
