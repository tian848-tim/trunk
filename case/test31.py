...
class test_flowsample_json(unittest.TestCase):
    ...
    def price(self):
        ...
        results = [(d['key']) for d in data ['price']]
    ...
    def moq(self):
        ...
        results = [(d['key']) for d in data ['moq']]
    ...
    def qty(self):
        ...
        results = [(d['key']) for d in data ['qty']]
    ...
    def test_productquotation(self):
            ...
            try:
                ...
                self.driver.find_element_by_xpath("//*[@id='FlowProductQuotationViewGridPanelID-body']/div/table/tbody/tr[1]//span[contains(text(),'{}')]".format('审批中')).is_displayed()
