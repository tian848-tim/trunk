...
class ProductCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/ProductCategory_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '产品分类——删除'
        # 脚本标识－ID
        self.script_id = 'ProductCategory_delete'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到产品分类删除
        self.driver.find_element_by_xpath("//*[@id='ProductCategoryView-body']//span[contains(@class,'fa-trash')]").click()
