...
class CustomClearance(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货计划业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_delete'
    ...
    def test_CustomClearance(self):
        ...
        # 定位到保存
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanForm']//span[contains(@class,'fa-save')]").click()
        ...
        # 定位到删除按钮
        self.driver.find_element_by_xpath( "//*[@id='FlowOrderShippingPlanView']//span[contains(@class, 'fa-trash')]").click()
