...
class CustomClearance(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_GM_retrial.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货计划业务流程测试——采购经理返审'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_GM_retrial'
    ...
    def test_CustomClearance(self):
        ...
        try:
            self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[1][0])).is_displayed()

            a =  su[1][0]


        except:
            print("经理元素不存在:",su[1][0])


        try:
            self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[2][0])).is_displayed()

            a = su[2][0]


        except:
            print("经理元素不存在:",su[2][0])



        try:
            self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[3][0])).is_displayed()

            a = su[3][0]


        except:
            print("经理元素不存在:",su[3][0])


        try:
            self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[4][0])).is_displayed()

            a = su[4][0]


        except:
            print("经理元素不存在:",su[4][0])


        try:
            self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanGridPanelID-body']/div/table/tbody/tr[1]//div[text()='{}']".format(su[5][0])).is_displayed()

            a = su[5][0]


        except:
            print("经理元素不存在:",su[5][0])
        ...
        self.driver.switch_to.frame(self.driver.find_element_by_xpath(
            "//*[@id='FlowOrderShippingPlaMainTabsPanelID-win-body']//iframe[contains(@class,'cke_wysiwyg_frame cke_reset')]"))
        ...
        # 点击返审
        self.driver.find_element_by_xpath(
            "//*[@id='FlowOrderShippingPlanForm']//span[contains(@class, 'fa-step-backward')]").click()
