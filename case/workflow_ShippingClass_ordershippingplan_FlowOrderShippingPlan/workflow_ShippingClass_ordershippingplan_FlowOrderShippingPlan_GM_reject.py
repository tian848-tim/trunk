...
class CustomClearance(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_GM_reject.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单发货计划业务流程测试——采购经理拒绝'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_ordershippingplan_FlowOrderShippingPlan_GM_reject'
    ...
    def test_CustomClearance(self):
        ...
        # 点击拒绝
        self.driver.find_element_by_xpath("//*[@id='FlowOrderShippingPlanForm']//span[contains(@class, 'fa-window-close')]").click()
