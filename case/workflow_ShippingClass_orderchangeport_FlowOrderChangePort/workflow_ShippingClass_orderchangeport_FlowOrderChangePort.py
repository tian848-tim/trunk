...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_orderchangeport_FlowOrderChangePort.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单港口变更'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_orderchangeport_FlowOrderChangePort'
    ...
    def test_CustomClearance(self):
        ...
        ul = self.driver.find_element_by_xpath("//*[@style='overflow: auto; height: auto;']/ul")
        ...
        # 点击通过
        self.driver.find_element_by_xpath("//*[@id='FlowOrderChangePortForm']//span[contains(@class, 'fa-check-square')]").click()
