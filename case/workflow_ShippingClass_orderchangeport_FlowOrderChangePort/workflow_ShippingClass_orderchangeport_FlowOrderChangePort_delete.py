...
class VendorCategory(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_ShippingClass_orderchangeport_FlowOrderChangePort_delete.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '订单港口变更业务流程测试——删除'
        # 脚本标识－ID
        self.script_id = 'workflow_ShippingClass_orderchangeport_FlowOrderChangePort_delete'
    ...
    def test_CustomClearance(self):
        ...
        # 定位到删除
        self.driver.find_element_by_xpath( "//*[@id='FlowOrderChangePortView']//span[contains(@class, 'fa-trash')]").click()
