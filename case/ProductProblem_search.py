...
class ProductCategory(unittest.TestCase):
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '问题记录——搜索'
        # 脚本标识－ID
        self.script_id = 'ProductProblem_search'
    ...
    def test_ProductCategory(self):
        ...
        # 定位到第一条记录
        self.driver.find_element_by_xpath("//*[@id='ProductProblemSubFormPanelID']//input[@name='keywords']").send_keys("AL")

        sleep(3)

        # 定位到问题记录搜索
        self.driver.find_element_by_xpath("//*[@id='ProductProblemSubFormPanelID']//span[contains(@class,'fa-search')]").click()
