...
class FeeRegister(unittest.TestCase):
    ...
    def loadvendername(self):
        ...
        global result
        file = open(rootPath + '/data/workflow_FinancialClass_feepayment_FlowFeePayment_WrittenDocuments.json', encoding='utf-8')
        data = json.load(file)
    ...
    def setUp(self):
        # 脚本标识－标题
        self.script_name = '费用支付-冲销费用'
        # 脚本标识－ID
        self.script_id = 'workflow_FinancialClass_feepayment_FlowFeePayment_WrittenDocuments'
